...
const Login = () => {
    ...
    return (
        <div className="bg-white text-black font-inter h-screen flex flex-col md:flex-row">

            <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-0 md:h-screen">
                <div className="bg-custom-img bg-center bg-cover w-full h-64 md:h-[98%] flex flex-col items-center justify-center rounded-3xl">
                    <svg width="200" height="120" viewBox="0 0 74 37" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[300px] md:h-[170px]">
                    ...
                    <Link to={"/"}>
                        <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white my-2">TEMPFORGE</h1>
                    </Link>
                </div>
            </div>

            {/* Right Side - Form */}
            <div className="bg-white w-full md:w-1/2 flex flex-col items-center p-6 md:p-10 lg:p-20">
                <h1 className="font-light text-4xl md:text-5xl lg:text-7xl my-1 text-center">
                    {isSigninForm ? 'SIGN IN' : 'SIGN UP'}
                </h1>
                <h1 className="text-lg md:text-xl lg:text-2xl font-extralight my-1 text-center px-4">
                    {isSigninForm ?
                        `Welcome back, your vault of prompts await you` :
                        'Welcome User, your vault of prompts await you'}
                </h1>

                <form className="flex flex-col items-center justify-center my-6 md:my-8 lg:my-12 w-full max-w-md">
                    {!isSigninForm &&
                        <input
                            ref={name}
                            type="text"
                            placeholder="Name"
                            className="w-full border-2 border-gray-400 rounded-2xl p-2.5 my-3 placeholder:text-lg md:placeholder:text-xl text-lg md:text-xl"
                        />
                    }
                    ...
                    <button
                        onClick={handleClick}
                        className="bg-blue-800 rounded-3xl w-full p-3 md:p-3.5 my-4 md:my-5 text-white font-bold text-lg md:text-xl"
                    >
                        {isSigninForm ? 'SIGN IN' : 'SIGN UP'}
                    </button>
                    ...
                    {isSigninForm && (
                        <>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center w-full">
                                <button
                                    className="p-2.5 flex m-2 bg-white text-black border border-zinc-500 rounded-lg w-full sm:w-auto justify-center"
                    ...
                    {!isSigninForm && (
                        <div className="w-full mt-1 mb-3">
                            ...
                            <ul className="text-xs md:text-sm text-gray-600 list-disc pl-5 mt-1">
                    ...
                    <p
                        className="cursor-pointer text-zinc-600 hover:text-zinc-800 my-2 text-center"
