...
const Login=()=>{
    ...
    return (
        <div className={'bg-white  text-black font-inter flex items-center justify-between h-screen'}>
            <div className={'bg-orange-500 h-full w-[50%] flex flex-col items-center justify-center'}>
                <div ></div>
            </div>
            <div className={'bg-white h-full w-[50%] flex flex-col items-center p-20'}>
                ...
                <h1 className={'text-xl font-extralight my-1'}>Welcome back, your vault of prompts await you</h1>
                <form className={'flex flex-col items-center justify-center my-12  w-full'}>
                    ...
                    {isSigninForm && <div className={'flex items-center justify-center'}>
                        <button
