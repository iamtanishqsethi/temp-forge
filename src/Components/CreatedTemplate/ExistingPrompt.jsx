...
const ExistingPrompt=()=>{
    ...
    return (
        <div className={'w-[70%] h-[98vh]  flex flex-col items-center justify-between p-4'}>
            <div className={' mb-5 mt-14 w-full h-[20%] flex items-center justify-center'}>
                <div className={'flex items-center justify-start w-full'}>
                    <div className={'bg-lightGreen rounded-full w-[7%] h-32 mr-2 p-2 flex flex-col space-y-2 items-center justify-center'}>
                    ...
                    <div className={'w-[94%]'}>
                        <h1 className={'text-7xl/[0.8] font-light text-black '}>
                            To
                            get the  <svg className={'inline'} width="70" height="72" viewBox="0 0 70 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className={'w-[92%] text-7xl/[0.8] font-light text-black'}>
                            <span className={'font-medium'}>Output </span>
                            enter <svg className={'inline'} width="48" height="48" viewBox="0 0 55 57" fill="none" xmlns="http://www.w3.org/2000/svg">
